<template>
    <div class="v-header backdrop-blur-sm bg-white/75 dark:bg-black/75">
        ...
        <div class="flex items-center pr-4 ml-auto">
            <!-- <SiteSearch /> -->
            <el-switch v-model="darkMode" inline-prompt :active-icon="Moon" :inactive-icon="Sunny" class="mx-2"
                @change="toggleDark()" style="--el-switch-on-color: #0960bd; --el-switch-off-color: #ff6600" />
